 ...
 */
final class Version20241230123537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bourse (id INT AUTO_INCREMENT NOT NULL, etudiant_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, remise DOUBLE PRECISION DEFAULT NULL, INDEX IDX_DDC2BC1CDDEAB1A3 (etudiant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, sexe VARCHAR(10) DEFAULT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) NOT NULL, is_registration_allowed TINYINT(1) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, num_telephone VARCHAR(20) NOT NULL, lieu_naissance VARCHAR(255) DEFAULT NULL, nationalite VARCHAR(100) DEFAULT NULL, student_photo VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, UNIQUE INDEX UNIQ_717E22E3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, etudiant_id INT NOT NULL, filiere_cycle_id INT NOT NULL, semestre_id INT NOT NULL, statut VARCHAR(50) NOT NULL, is_suspended TINYINT(1) NOT NULL, date_inscription DATE NOT NULL, INDEX IDX_5E90F6D6DDEAB1A3 (etudiant_id), INDEX IDX_5E90F6D6713D4CBA (filiere_cycle_id), INDEX IDX_5E90F6D65577AFDB (semestre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE professeur (id INT AUTO_INCREMENT NOT NULL, departement_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, numero_telephone VARCHAR(255) DEFAULT NULL, cni VARCHAR(255) NOT NULL, date_naissance DATE DEFAULT NULL, nationalite VARCHAR(255) DEFAULT NULL, sexe VARCHAR(10) DEFAULT NULL, adresse VARCHAR(255) NOT NULL, photo_profil VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME NOT NULL, UNIQUE INDEX UNIQ_17A55299E7927C74 (email), INDEX IDX_17A55299CCF9E01E (departement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
