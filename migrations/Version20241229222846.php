 ...
 */
final class Version20241229222846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE campus (id INT AUTO_INCREMENT NOT NULL, nom_campus VARCHAR(100) NOT NULL, adresse VARCHAR(200) NOT NULL, UNIQUE INDEX UNIQ_9D0968111DC6F746 (nom_campus), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE salle_cours (id INT AUTO_INCREMENT NOT NULL, campus_id INT NOT NULL, nom_salle VARCHAR(150) NOT NULL, capacite INT NOT NULL, INDEX IDX_10CF8FF5AF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
